...
import {
    ...
    ShoppingCart, X, CheckCircle, TestTube,
} from 'lucide-react';
                        ...
                        <div className="card" style={{ padding: 24 }}>
                            ...
                            <ResponsiveContainer width="100%" height={240}>
                                <LineChart data={trendData} margin={{ left: -20 }}>
                                    ...
                                    <XAxis dataKey="month" tick={{ fontSize: 11, fill: '#64748b' } as any} axisLine={false} tickLine={false} />
                                    <YAxis tick={{ fontSize: 11, fill: '#64748b' } as any} axisLine={false} tickLine={false} />
