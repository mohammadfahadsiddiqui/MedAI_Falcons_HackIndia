                            ...
                            <div className="card" style={{ padding: 22 }}>
                                ...
                                <ResponsiveContainer width="100%" height={200}>
                                    <LineChart data={trendSeed}>
                                        ...
                                        <XAxis dataKey="date" tick={{ fontSize: 11, fill: 'var(--text-muted)' } as React.CSSProperties} axisLine={false} tickLine={false} />
                                        <YAxis domain={[1, 7]} tick={{ fontSize: 11, fill: 'var(--text-muted)' } as React.CSSProperties} axisLine={false} tickLine={false} />
